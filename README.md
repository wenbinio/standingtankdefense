...
| [`docs/09-roblox-port-assessment.md`](docs/09-roblox-port-assessment.md) | **Roblox port & market assessment.** What a Luau port actually costs component-by-component (no native code = full rewrite, but ~70% of the netcode disappears), the three hard problems, and an honest read on whether the game as designed fits how Roblox monetizes and retains. |
