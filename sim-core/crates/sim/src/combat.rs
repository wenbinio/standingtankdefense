...
mod tests {
    ...
    fn fortified_armor_reduces_damage() {
        ...
        let dealt_pierce =
            apply_weapon_hit(&mut g_pierce, base, content::DMG_PIERCING, Fixed::ONE, cond, &content::StatusOnHit::NONE);
        ...
        let dealt_siege =
            apply_weapon_hit(&mut g_siege, base, content::DMG_SIEGE, Fixed::ONE, cond, &content::StatusOnHit::NONE);
