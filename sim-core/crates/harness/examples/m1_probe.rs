...
fn main() {
    ...
    for tick in 0..205 {
        r.step(input_at(&sc, tick));
    }
    println!(
        "pre-injection : in_sync={} corrections={}",
        r.in_sync(),
        r.corrections
    );
    ...
    println!(
        "after boundary: in_sync={} corrections={} at_tick={:?} bytes_match={}",
        r.in_sync(),
        r.corrections,
        r.last_correction_tick,
